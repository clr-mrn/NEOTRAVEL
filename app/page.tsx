    ...
    <main className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{ background: "radial-gradient(ellipse, #1AA89A 0%, #0d7a71 50%, transparent 75%)" }}
        />
        <div
      ...
      <nav className="relative z-10 flex items-center px-8 py-6 md:px-16">
        <span className="text-white font-bold text-xl tracking-wide">
          Neo<span style={{ color: "#1AA89A" }}>Travel</span>
        </span>
      </nav>
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, transparent, rgba(26,168,154,0.3), transparent)" }}
      />
    </main>
  );
}
